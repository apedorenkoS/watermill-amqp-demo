...
import (
	...
	"github.com/apedorenkoS/watermill-amqp-demo/random-single-and-one-everything/single-consumer/internal/event"
...
func main() {
	...
	transport, err := event.NewTransport(conf, "single.queue.for.consumers", conf.RoutingKey)
	if err != nil {
